...
export class MaxRequestId {
  public readonly maxRequestId: bigint

  constructor(maxRequestId: bigint | number) {
    this.maxRequestId = BigInt(maxRequestId)
  }
  ...
  serialize(): FrozenByteBuffer {
    ...
    payload.putVI(this.maxRequestId + 1n)
...
if (import.meta.vitest) {
  ...
  describe('MaxRequestId', () => {
    test('roundtrip', () => {
      ...
      expect(deserialized.maxRequestId).toBe(maxRequestId.maxRequestId + 1n)
